...
public class JspSampleGraph {

    private final int TOTAL_NODES = 5120;
    ...
    public JspSampleGraph() throws InterruptedException {

        createNodes();
        linkNodes(); setUpDisplay();
    }
    ...
    private void createNodes() throws InterruptedException {
        for (int i = 0; i < TOTAL_NODES; i++) {
            ...
            node.addAttribute("ui.style", "size: 5px;");
            nodes.add(node);
        }
    }
